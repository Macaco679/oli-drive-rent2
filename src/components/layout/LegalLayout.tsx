...
import { Phone, MessageCircle, ArrowLeft, FileText, ShieldCheck, ArrowRight, Lock } from "lucide-react";
...
const LEGAL_PAGES = [
  ...
  { path: "/politica-de-seguranca", label: "Política de Segurança", icon: Lock },
];
